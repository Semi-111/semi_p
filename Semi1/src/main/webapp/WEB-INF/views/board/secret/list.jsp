...
<div class="container">
  ...
  <form name="searchForm" action="${pageContext.request.contextPath}/bbs/secretBoard/list" method="get">
    <!-- type 파라미터 숨겨진 필드 제거 -->
    ...
    <div class="board-controls">
      ...
      <!-- "글쓰기" 버튼에서 type 파라미터 제거 -->
      <button type="button" class="write-button" onclick="location.href='${pageContext.request.contextPath}/bbs/secretBoard/write'">
      ...
      <c:forEach var="dto" items="${list}" varStatus="status">
        <div class="post-item">
          <div class="post-content">
            <h3 class="post-title">
              <!-- 게시글 링크에서 type 파라미터 제거 -->
              <a href="${pageContext.request.contextPath}/bbs/secretBoard/article?cmNum=${dto.cmNum}&page=${page}">
                  ${dto.title}
              </a>
            </h3>
  ...
  <div class="pagination">
    <ul>
      <!-- 게시글이 없을 경우 메시지 표시, 있을 경우 페이징 표시 -->
