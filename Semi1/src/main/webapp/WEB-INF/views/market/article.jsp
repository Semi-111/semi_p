...
<body>
	<header>
		<nav>
			<div class="logo">
				<img
					src="${pageContext.request.contextPath}/test/images/trainee.png"
					alt="트레이니 로고">
			</div>
			<div class="nav-links">
			...
			<div class="post-content">
				...
				<c:if test="${not empty dto.fileName}">
					<div class="post-file">
						<p>
							첨부파일: <a
								href="${pageContext.request.contextPath}/market/download?marketNum=${dto.marketNum}">${dto.fileName}</a>
						</p>
					</div>
				</c:if>
			</div>
