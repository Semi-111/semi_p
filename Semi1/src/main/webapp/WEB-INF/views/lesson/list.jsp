...
<body>
   ...
   <div class="container">
       ...
       <div class="board-header">
           <div class="board-nav">
               <a href="${pageContext.request.contextPath}/lessonBoard/list" class="${category==0?'active':''}">전체</a>
               <a href="${pageContext.request.contextPath}/lessonBoard/list?category=51" class="${category==51?'active':''}">경영학</a>
               <a href="${pageContext.request.contextPath}/lessonBoard/list?category=52" class="${category==52?'active':''}">경찰행정</a>
               <a href="${pageContext.request.contextPath}/lessonBoard/list?category=53" class="${category==53?'active':''}">디자인</a>
               <a href="${pageContext.request.contextPath}/lessonBoard/list?category=54" class="${category==54?'active':''}">화학공학</a>
               <a href="${pageContext.request.contextPath}/lessonBoard/list?category=55" class="${category==55?'active':''}">컴퓨터응용전자</a>
               <a href="${pageContext.request.contextPath}/lessonBoard/list?category=56" class="${category==56?'active':''}">정보통신</a>
           </div>
           <a href="${pageContext.request.contextPath}/lessonBoard/writeForm" class="write-button">글쓰기</a>
       </div>

       <div class="search-box">
           <form name="searchForm" action="${pageContext.request.contextPath}/lessonBoard/list" method="post">
