...
public class MemberDAO {
	...
	public void insertMember(MemberDTO dto) throws SQLException {
		...
		try {
			...
			sql = "INSERT INTO member(mb_Num, userId, pwd, nickName, ca_Day, modifyDay, role, lessonNum, block) VALUES (member_seq.NEXTVAL, ?, ?, ?, SYSDATE, SYSDATE, 1, ?, 1)";
			pstmt = conn.prepareStatement(sql);
			...
			sql = "INSERT INTO dt_member(mb_Num, name, email, birthday, tel, studentnum) VALUES (member_seq.NEXTVAL, ?, ?, TO_DATE(?,'YYYY-MM-DD'), ?, ?)";
			pstmt = conn.prepareStatement(sql);
			...
			pstmt.setInt(5, dto.getStudentNum());
