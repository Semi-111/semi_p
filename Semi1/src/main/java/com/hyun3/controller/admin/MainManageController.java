...
import com.hyun3.dao.Membership.MembershipDAO;
...
public class MainManageController {
	...
	public ModelAndView main(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			List<ReportDTO> recentReports = reportDAO.getRecentReports();

			// 최근 신고 내역을 JSP에 전달
			mav.addObject("recentReports", recentReports);
	...
	// 신고 목록 조회
	@RequestMapping(value = "/admin/home/report", method = RequestMethod.GET)
